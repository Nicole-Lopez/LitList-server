...
export type BestSellersListResponse = {
  __typename?: 'BestSellersListResponse';
  books?: Maybe<Array<Maybe<BookPreview>>>;
...
export type Query = {
  __typename?: 'Query';
  bestSellersList?: Maybe<BestSellersListResponse>;
};
...
export type ResolversTypes = ResolversObject<{
  BestSellersListResponse: ResolverTypeWrapper<BestSellersListResponse>;
...
export type ResolversParentTypes = ResolversObject<{
  BestSellersListResponse: BestSellersListResponse;
...
export type BestSellersListResponseResolvers<ContextType = ContextServer, ParentType extends ResolversParentTypes['BestSellersListResponse'] = ResolversParentTypes['BestSellersListResponse']> = ResolversObject<{
  books?: Resolver<Maybe<Array<Maybe<ResolversTypes['BookPreview']>>>, ParentType, ContextType>;
...
export type QueryResolvers<ContextType = ContextServer, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  bestSellersList?: Resolver<Maybe<ResolversTypes['BestSellersListResponse']>, ParentType, ContextType, Partial<QueryBestSellersListArgs>>;
}>;

export type Resolvers<ContextType = ContextServer> = ResolversObject<{
  BestSellersListResponse?: BestSellersListResponseResolvers<ContextType>;
